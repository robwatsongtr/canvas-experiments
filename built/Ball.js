export class Ball {
    ...
    animateHoriz(ctx) {
        ...
        ctx.clearRect(this.xpos - this.sizeRadius, this.ypos - this.sizeRadius, this.sizeRadius * 2, this.sizeRadius * 2);
        // change position 
        this.xpos += this.dx;
        this.ypos += this.dy;
        // draw ball
        ...
        if (this.xpos + (this.sizeRadius * 2) > ctx.canvas.width ||
    ...
    animateVert(ctx) {
        ...
        if (this.ypos + (this.sizeRadius * 2) > ctx.canvas.height ||
